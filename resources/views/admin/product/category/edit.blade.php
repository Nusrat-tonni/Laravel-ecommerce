            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-body">
                        ...
                        <hr/>
                        <form method="POST" class="update_form" action="{{ route('category.update', $category->id) }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                   <input type="text" name="name" value="{{ $category->name }}" class="form-control" id="input-21" /> 
                                   <span class="text-danger name"></span>
