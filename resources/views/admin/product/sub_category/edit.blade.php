...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid">
            @include('admin.includes.bread_crumb', ['title' => 'Edit Sub Category'])
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-body">
                        <div class="card-title">Edit Sub Category</div>
                        <hr />
                        <form method="POST" class="update_form" action="{{ route('sub_category.update', $sub_category->id) }}"
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select name="main_category_id" class="form-control" id="">
                                        ...
                                        @foreach ($main_category as $item)
                                            <option {{ $sub_category->main_category_id == $item->id ? 'selected' : '' }}
