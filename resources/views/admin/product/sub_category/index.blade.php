                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('sub_category.create') }}" class="btn btn-warning"><i
                                    ...
                                    <tbody>
                                        @foreach ($collection as $key => $item)
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    {{ $item->category_info ? $item->category_info->name : '' }}</td>
                                                <td scope="row">
                                                    {{ $item->main_category_info ? $item->main_category_info->name : '' }}
                                                </td>
                                                <td scope="row"></td>
                                                <td scope="row">
                                                    <div class="text-right">
                                                        ...
                                                        <a type="button"
                                                            href="{{ route('sub_category.destroy', $item->id) }}"
