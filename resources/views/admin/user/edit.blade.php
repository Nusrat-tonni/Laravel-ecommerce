                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin_user_update') }}" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="first_name" value="{{ $user->first_name }}" class="form-control" id="input-21"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username" value="{{ $user->username}}"  class="form-control" id="input-21"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {{-- <input type="text" name="role_id" class="form-control" id="input-21"placeholder=" User Name" /> --}}
                                    <select name="role-id" class="form-control"  id="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="email" value="{{ $user->email }}" class="form-control" id="input-22"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="phone" value="{{ $user->phone }}" class="form-control" id="input-23"
                                        placeholder="phone" />
                                        @error('phone')
                                           <div class="text-warning">{{ $message }}</div> 
                                        @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="old_password" value="{{ $user->password }}" class="form-control" id="input-24"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" value="{{ $user->password }}" class="form-control" id="input-24"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password_confirmation" class="form-control" id="input-25"
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                     <img src="/{{ $user->image }}" style="height: 50px; margin-bottom:10px" alt="user image"><br>
