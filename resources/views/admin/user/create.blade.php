                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin_user_store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="first_name" class="form-control" id="input-21"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="last_name"   class="form-control" id="input-21"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="username"   class="form-control" id="input-21"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="email" class="form-control" id="input-22"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="phone" class="form-control" id="input-23"
                                        placeholder="phone" />
                                        @error('phone')
                                           <div class="text-warning">{{ $message }}</div> 
                                        @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="old_password" class="form-control" id="input-24"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" class="form-control" id="input-24"
