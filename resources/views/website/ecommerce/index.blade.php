        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    @include('website.ecommerce.home_include.testimonils')
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="single-banner">
                                    <a href="#">
                                        <img src="{{ asset('contents/website') }}/images/banner/4.jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="single-banner">
                                    <a href="#">
                                        <img src="{{ asset('contents/website') }}/images/banner/5.jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="brand-active box-shadow p-15 bg-fff">
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/1.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/2.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/3.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                ...
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/4.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/5.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/6.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/7.jpg" alt="" />
                    </a>
                </div>
                <div class="single-brand">
                    <a href="#">
                        <img src="{{ asset('contents/website') }}/images/brand/8.jpg" alt="" />
                    </a>
                </div>
            </div>
        </div>
