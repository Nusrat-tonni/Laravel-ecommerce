                                ...
                                {{-- <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                        <div class="product-wrapper bg-fff mb-30">
                                            <div class="product-img">
                                                <a href="#">
                                                    <img src="{{ asset('contents/website') }}/images/product/11.jpg"
                                                        alt="" class="primary" />
                                                    <img src="{{ asset('contents/website') }}/images/product/12.jpg"
                                                        alt="" class="secondary" />
                                                </a>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="#" data-bs-toggle="tooltip"
                                                                ...
                                                                data-bs-original-title="Add to cart"><i
                                                                    class="fa fa-shopping-cart"></i></a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-bs-toggle="tooltip" aria-label="Wishlist"
                                                                data-bs-original-title="Wishlist"><i
                                                                    class="fa fa-heart-o"></i></a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-bs-toggle="tooltip" aria-label="Compare"
                                                        ...
                                                        <li>
                                                            <a href="#" data-bs-toggle="tooltip"
                                                                ...
                                                                data-bs-original-title="Accumsan eli"><i
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-12">
                ...
                <div class="filter-by-price-area mtb-30 bg-fff box-shadow">
                    ...
                    <div class="filter-by-price p-20-15">
                        ...
                        <div id="slider-range"
                            ...
                            <div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 0.4%; width: 99.6%;">
                            </div>
                            <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default"
                                style="left: 0.4%;"></span><span tabindex="0"
                ...
                <div class="compare-area bg-fff box-shadow">
                    ...
                    <div class="compare-menu p-20">
                        ...
                        <a href="#">Clear all</a>
                        <a href="#" data-bs-toggle="tooltip" class="pull-right compare text-uppercase"
                            data-bs-original-title="Compare">Compare </a>
                    </div>
                </div>
                ...
                <div class="featured-area bg-fff box-shadow mb-30">
                    ...
                    <div class="featured-wrapper p-20">
                        ...
                        <div class="product-wrapper single-featured mb-10">
                            <div class="product-img floatleft">
                                <a href="#">
