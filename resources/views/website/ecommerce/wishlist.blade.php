                    ...
                    <tbody>
                        <tr class="cart-item">
                            ...
                            <td class="product-thumbnail product-thumbnail-img hidden-sm hidden-xs">
                                <a href="#">
                                    <img src="{{ asset('contents/website') }}/images/cart/1.jpg" alt="" />
                                </a>
                            </td>
                        ...
                        <tr class="cart-item">
                            ...
                            <td class="product-thumbnail product-thumbnail-img hidden-sm hidden-xs">
                                <a href="#">
                                    <img src="{{ asset('contents/website') }}/images/cart/4.jpg" alt="" />
                                </a>
                            </td>
                            <td class="product-name">
                                <a href="#">Lorem nec augue </a>
                        ...
                        <tr class="cart-item">
                            ...
                            <td class="product-thumbnail product-thumbnail-img hidden-sm hidden-xs">
                                <a href="#">
                                    <img src="{{ asset('contents/website') }}/images/cart/5.jpg" alt="" />
                                </a>
                            </td>
                            <td class="product-name">
